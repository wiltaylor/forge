...
pub struct Ctx {
    ...
    /// *not* reach a widget: widgets paint with the ambient theme, so an app
    /// that switches theme mid-run must also call
    /// [`set_ambient_theme`](crate::theme::set_ambient_theme).
    pub theme: Theme,
    pub focus: FocusRing,
...
/// [`set_ambient_theme`](crate::theme::set_ambient_theme); every widget follows
