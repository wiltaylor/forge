/* Widget transport seam. The viewer speaks a WebSocket-subset interface so
   ...
   JSON, binary frames carry RGBA rects — the discriminator is load-bearing
   (docs/widgets-protocol.md).

   The same structural interface is declared in @forge/term and
